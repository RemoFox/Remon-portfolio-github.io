...
,6400);
    ...
    var swiper = new Swiper(".mySwiper", {
      ...
      ScrollReveal().reveal(' .about .row .imagee img , .education .row .imagee img, .icon', { delay:200 ,origin:'right'});
      ScrollReveal().reveal(' .about .row  .content ,  .education .row .content , .contact .row  .information', 
      ...
      let ABB=document.querySelector('#abou');
       ...
       function ho(){
        Hom.style.boxShadow="0 0 5px 5px #00E77F ";
       ...
       function pro(){
            PRO.style.boxShadow="0 0 5px 5px #00E77F ";
             skil.style.boxShadow="none ";
             ABB.style.boxShadow="none ";
      ...
      function abo(){
      ABB.style.boxShadow="0 0 5px 5px #00E77F ";
       skil.style.boxShadow="none ";
       Hom.style.boxShadow="none ";
       PRO.style.boxShadow="none ";
       EDU.style.boxShadow="none ";
      ...
      function ski(){
        ABB.style.boxShadow="none ";
        skil.style.boxShadow="0 0 5px 5px #00E77F ";
        Hom.style.boxShadow="none ";
        PRO.style.boxShadow="none ";
        EDU.style.boxShadow="none ";
        CON.style.boxShadow="none ";
      ...
      function edu(){
        EDU.style.boxShadow="0 0 5px 5px #00E77F ";
         skil.style.boxShadow="none ";
         ABB.style.boxShadow="none ";
         Hom.style.boxShadow="none ";
         PRO.style.boxShadow="none ";
        ...
        function con(){
            CON.style.boxShadow="0 0 5px 5px #00E77F ";
             skil.style.boxShadow="none ";
             ABB.style.boxShadow="none ";
             EDU.style.boxShadow="none ";
             PRO.style.boxShadow="none ";
